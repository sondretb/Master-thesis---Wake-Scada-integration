...
def plot_flowmap_demo(deficit_model: DeficitModel, deflection_model: DeflectionModel, turbulence_model: TurbulenceModel, yaw=None, ws=10, wd=270, plot_turbulence = False, print_numbers= False):
    if yaw:
...
plot_flowmap_demo(deficit_model=BastankhahGaussian, 
